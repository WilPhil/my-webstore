...
class RegionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($provinces as $province) {
            ...
            $this->command->info("Fetching regencies of {$province['name']}...");
            ...
            foreach ($regencies as $regency) {
                ...
                $this->command->info("Fetching districts of {$regency['name']}...");
                ...
                foreach ($districts as $district) {
                    ...
                    $this->command->info("Fetching villages of {$district['name']}...");

...
new class extends Component {
    ...
    public function mount($product, CartServiceInterface $cart): void
    {
    ...
    public function addToCart(CartServiceInterface $cart): void
    {
        $this->validate();

        $cart->addOrUpdateItem(new CartItemData(sku: $this->sku, quantity: $this->quantity, weight: $this->weight, price: $this->price));
...
<div class="gap-2 ">
    ...
    <div class="flex items-center gap-2">
        <div x-data="{ quantity: $wire.entangle('quantity') }" class="flex gap-2 items-centerm y-5">
            <div
                class="@error('quantity')
                   border-red-500
                @enderror px-3 py-2 bg-white border border-gray-200 rounded-lg dark:bg-neutral-900 dark:border-neutral-700">
    ...
    <div class="flex items-center gap-2 mt-1">
        <span class="text-sm">Stok sisa {{ $this->stock }}</span>
    </div>
</div>
